...
Route::get('/dashboard-siswa', [Siswa::class, 'dashboard'])->middleware('siswa');
...
Route::delete('admin/mutasi/{mutasi}', [Admin::class, 'delete_mutasi'])->middleware('admin');
...
Route::get('admin/print/zip', [Printer::class, 'buku_induk_zip'])->middleware('admin');

// Excel Routes
Route::get('/excel/import', [App\Http\Controllers\ExcelController::class, 'importForm'])->name('excel.import.form')->middleware('admin');
Route::post('/excel/import', [App\Http\Controllers\ExcelController::class, 'import'])->name('excel.import')->middleware('admin');
Route::get('/excel/export', [App\Http\Controllers\ExcelController::class, 'export'])->name('excel.export')->middleware('admin');
Route::get('/excel/template', [App\Http\Controllers\ExcelController::class, 'template'])->name('excel.template')->middleware('admin');
