      ...
      <div class="row justify-content-center">
        <div class="col-lg-4">
          <table class="table">
            ...
            <tr>
              <th>MPSN / MPN / MMT</th>
              <td>{{auth()->user()->biodata->mpsn_mpn_mmt ?: '-'}}</td>
            </tr>
            <tr>
              <th>NIK / No. KK</th>
              <td>{{auth()->user()->biodata->nik_no_kk ?: '-'}}</td>
            </tr>
            <tr>
              <th>RT / RW</th>
              <td>{{auth()->user()->biodata->rt_rw ?: '-'}}</td>
            </tr>
            <tr>
              <th>Kode Pos</th>
              <td>{{auth()->user()->biodata->kode_pos ?: '-'}}</td>
            </tr>
            <tr>
              <th>Alamat</th>
        ...
        <div class="col-lg-4">
          <table class="table">
            <tr>
              ...
              <td>{{auth()->user()->biodata->tinggal_bersama ?: '-'}}</td>
            </tr>
            <tr>
              <th>Moda Kendaraan</th>
              <td>{{auth()->user()->biodata->moda_kendaraan ?: '-'}}</td>
            </tr>
            <tr>
