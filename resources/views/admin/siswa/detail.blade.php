        ...
        <div class="col-lg-5">
          <table class="table">
            ...
            <tr>
              <th>MPSN / MPN / MMT</th>
              <td>:</td>
              <td>{{$res->biodata->mpsn_mpn_mmt}}</td>
            </tr>
            <tr>
              <th>NIK / No. KK</th>
              <td>:</td>
              <td>{{$res->biodata->nik_no_kk}}</td>
            </tr>
            <tr>
              <th>RT / RW</th>
              <td>:</td>
              <td>{{$res->biodata->rt_rw}}</td>
            </tr>
            <tr>
              <th>Kode Pos</th>
              <td>:</td>
              <td>{{$res->biodata->kode_pos}}</td>
            </tr>
            <tr>
              <th>Sekolah Asal</th>
              <td>:</td>
        ...
        <div class="col-lg-5">
          <table class="table">
            ...
            <tr>
              <th>Alamat Email</th>
              <td>:</td>
              <td style="word-break: break-word; white-space: normal;">{{$res->email}}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>:</td>
              <td>{{$res->biodata->tinggal_bersama}}</td>
            </tr>
            <tr>
              <th>Moda Kendaraan</th>
              <td>:</td>
              <td>{{$res->biodata->moda_kendaraan}}</td>
            </tr>
            <tr>
