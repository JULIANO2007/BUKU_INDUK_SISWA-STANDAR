              ...
              <!-- Tabs navs -->
                  ...
                  <div class="tab-content" id="ex2-content" style="height: fit-content">
                    ...
                    >
                      ...
                      <div class="input-group mb-3">
                        ...
                        <select name="agama" class="form-select">
                          ...
                          <option value="Konghucu"  @if ($res->agama === 'Konghucu') selected @endif>Konghucu</option>
                        </select>
                      </div>
                      <div class="input-group mb-3">
                    ...
                    >
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text bg-light">MPSN / MPN / MMT</span>
                        <input type="text" class="form-control @error('mpsn_mpn_mmt') is-invalid @enderror" placeholder="Contoh : 12345678" name="mpsn_mpn_mmt" value="{{$res->mpsn_mpn_mmt}}">
                        @error('mpsn_mpn_mmt')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text bg-light">NIK / No. KK</span>
                        <input type="text" class="form-control @error('nik_no_kk') is-invalid @enderror" placeholder="Contoh : 1234567890123456" name="nik_no_kk" value="{{$res->nik_no_kk}}">
                        @error('nik_no_kk')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text bg-light">RT / RW</span>
                        <input type="text" class="form-control @error('rt_rw') is-invalid @enderror" placeholder="Contoh : 001 / 002" name="rt_rw" value="{{$res->rt_rw}}">
                        @error('rt_rw')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text bg-light">Kode Pos</span>
                        <input type="text" class="form-control @error('kode_pos') is-invalid @enderror" placeholder="Contoh : 12345" name="kode_pos" value="{{$res->kode_pos}}">
                        @error('kode_pos')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text bg-light">Tinggal Bersama</span>
                        <select name="tinggal_bersama" class="form-select">
                          <option value="" @if ($res->tinggal_bersama === null || $res->tinggal_bersama === '') selected @endif>Pilih Tinggal Bersama</option>
                          <option value="Orang Tua" @if ($res->tinggal_bersama === 'Orang Tua') selected @endif>Orang Tua</option>
                          <option value="Nenek/Kakek" @if ($res->tinggal_bersama === 'Nenek/Kakek') selected @endif>Nenek/Kakek</option>
                          <option value="Saudara" @if ($res->tinggal_bersama === 'Saudara') selected @endif>Saudara</option>
                          <option value="Wali" @if ($res->tinggal_bersama === 'Wali') selected @endif>Wali</option>
                          <option value="Sendiri" @if ($res->tinggal_bersama === 'Sendiri') selected @endif>Sendiri</option>
                          <option value="Lainnya" @if ($res->tinggal_bersama === 'Lainnya') selected @endif>Lainnya</option>
                        </select>
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text bg-light">Moda Kendaraan</span>
                        <select name="moda_kendaraan" class="form-select">
                          <option value="" @if ($res->moda_kendaraan === null || $res->moda_kendaraan === '') selected @endif>Pilih Moda Kendaraan</option>
                          <option value="Sepeda Motor" @if ($res->moda_kendaraan === 'Sepeda Motor') selected @endif>Sepeda Motor</option>
                          <option value="Becak" @if ($res->moda_kendaraan === 'Becak') selected @endif>Becak</option>
                          <option value="Grab" @if ($res->moda_kendaraan === 'Grab') selected @endif>Grab</option>
                          <option value="Angkutan Umum" @if ($res->moda_kendaraan === 'Angkutan Umum') selected @endif>Angkutan Umum</option>
                          <option value="Jalan Kaki" @if ($res->moda_kendaraan === 'Jalan Kaki') selected @endif>Jalan Kaki</option>
                          <option value="Sepeda" @if ($res->moda_kendaraan === 'Sepeda') selected @endif>Sepeda</option>
                          <option value="Mobil Pribadi" @if ($res->moda_kendaraan === 'Mobil Pribadi') selected @endif>Mobil Pribadi</option>
                          <option value="Lainnya" @if ($res->moda_kendaraan === 'Lainnya') selected @endif>Lainnya</option>
                        </select>
                        @error('moda_kendaraan')
                          <div class="invalid-feedback">
                            {{ $message }}
                          </div>
                        @enderror
