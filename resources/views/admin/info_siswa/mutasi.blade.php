        ...
        <div class="col-lg-8">
          <form action="/admin/mutasi/{{$res->nisn}}" method="post">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('alasan') is-invalid @enderror" name="alasan" value="@if($res->mutasi) {{$res->mutasi->alasan}} @endif" placeholder="Contoh: Pindah Rumah">
              @error('alasan')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
