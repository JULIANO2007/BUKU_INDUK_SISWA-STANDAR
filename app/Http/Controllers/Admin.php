...
class Admin extends Controller
{
    public function index(){
        ...
        $siswa = User::where('status', 'siswa')->latest()->get();
        ...
        return view('admin/dashboard', [
            ...
            'kelas' => $kelas,
            'jumlah_mutasi' => Mutation::whereHas('user', function($q){ $q->where('status', 'siswa'); })->count(),
            'mutasi' => $mutasi,
    ...
    public function edit_bio(Request $request, Biodata $biodata){
        $validated = $request->validate([
            ...
            'jlh_saudara' => 'nullable|gte:0',
            'saudara_tiri' => 'nullable|gte:0',
            'saudara_angkat' => 'nullable|gte:0',
            'bahasa' => 'required',
            'agama' => 'required',
            'jarak' => 'required|gt:0',
            ...
            'mpsn_mpn_mmt' => 'nullable|string',
            'nik_no_kk' => 'nullable|string',
            'rt_rw' => 'nullable|string',
            'kode_pos' => 'nullable|string',
            'tinggal_bersama' => 'nullable|string',
            'moda_kendaraan' => 'nullable|string',
        ]);
    ...
    public function delete_mutasi(Mutation $mutasi){
        $mutasi->delete();
        return redirect('/admin/mutasi')->with('success', 'Data mutasi berhasil dihapus');
    }
}
